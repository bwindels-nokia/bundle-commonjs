...
BundleBuilder.prototype.sourceCode = function(callback) {
    ...
    this._addModules(function(err) {
        ...
        var source = createClientSource(modules, this.moduleBuilder.aliases(), this.predefinedModules, this.requireFnName);
        this.moduleBuilder = null;
        callback(null, source);
    }.bind(this));
};

BundleBuilder.prototype.setRequireGlobalName = function(requireFnName) {
    this.requireFnName = requireFnName;
};
